...
**A clean, modern streaming front-end for Android.**
...
[![Version](https://img.shields.io/badge/version-1.5.9-blue?style=for-the-badge)](https://github.com/clipboxstreaming/releases/releases/latest)
...
### 👉 **[Download the latest version from Github](https://github.com/clipboxstreaming/releases/releases/latest)**

On the release page, download the latest file ending in **`.apk`**.

> Always install the newest release. Older versions may stop working as sources change, and the app will prompt you when an update is available.

or, directly from our site

### 👉 **[Download the latest version from our site](https://clipbox.mov/download)**

---

## 📲 Installation

ClipBox isn't on the Play Store, so you install it directly (sideload). It's quick:

1. **Download** the `.apk` from the [latest release](https://github.com/clipboxstreaming/releases/releases/latest) - do this on your phone, or transfer the file to it.
2. **Open** the downloaded file (check your **Downloads** folder or the download notification).
3. Android will ask to **allow installs from this source** - tap **Settings**, enable **Allow from this source**, then go back.
4. Tap **Install**, then **Open**. Done! 🎉
...
Yes. ClipBox is a standalone app installed directly from this repository's releases. "Allow from this source" is Android's standard prompt for any app not from the Play Store.
...
ClipBox does **not** host, store, upload, or provide any media content. All streams, subtitles, and other materials come from **third-party sources** that are not affiliated with, endorsed by, or controlled by ClipBox.
...
- **Subtitles:** [OpenSubtitles](https://www.opensubtitles.org)
- **Playback:** AndroidX Media3 / ExoPlayer (Apache 2.0)
