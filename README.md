...
### 👉 **[Download the latest version](https://github.com/clipboxstreaming/releases/releases/latest)**

On the release page, download the file ending in **`.apk`** under **Assets**.
...
It's distributed here as a direct download.
